...
PARAM  <- list()
PARAM$experimento <- "TS9310_v2"

PARAM$exp_input  <- "FE9250_v2"
...
dataset_input  <- paste0( "./exp/CompetenciaFinal/", PARAM$exp_input, "/dataset.csv.gz" )
