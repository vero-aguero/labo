...
PARAM  <- list()
PARAM$experimento <- "CompetenciaFinal/TS9320_v10"

PARAM$exp_input  <- "CompetenciaFinal/FE9250_v10"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202003, 202011, 202012, 202101, 202102, 202103, 202104, 202105 )
