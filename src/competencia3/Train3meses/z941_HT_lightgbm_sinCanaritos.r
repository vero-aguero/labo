...
PARAM  <- list()
PARAM$experimento <- "HT9410_sinCanaritos"

PARAM$exp_input  <- "TS9310_sinCanaritos"
...
exp_log  <- function( reg, arch=NA, folder="./exp/ExperimentoColectivo/Train3meses", ext=".txt", verbose=TRUE )
{
  archivo  <- arch
...
dataset_input  <- paste0( "./exp/ExperimentoColectivo/Train3meses/", PARAM$exp_input, "/dataset_training.csv.gz" )
...
dir.create( paste0( "./exp/ExperimentoColectivo/Train3meses/", PARAM$experimento, "/"), showWarnings = FALSE )
setwd(paste0( "./exp/ExperimentoColectivo/Train3meses/", PARAM$experimento, "/"))   #Establezco el Working Directory DEL EXPERIMENTO
