...
PARAM  <- list()
PARAM$experimento <- "TS9310_sinCanaritos"

PARAM$exp_input  <- "FE9250_sinCanaritos"
...
dataset_input  <- paste0( "./exp/ExperimentoColectivo/Train3meses/", PARAM$exp_input, "/dataset.csv.gz" )
