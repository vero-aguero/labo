...
PARAM  <- list()
PARAM$experimento <- "TS9311_sinCanaritos"

PARAM$exp_input  <- "FE9251_sinCanaritos"
...
dataset_input  <- paste0( "./exp/ExperimentoColectivo/WithUnderSampling/", PARAM$exp_input, "/dataset.csv.gz" )
