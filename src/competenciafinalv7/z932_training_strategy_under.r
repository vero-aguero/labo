...
PARAM  <- list()
PARAM$experimento <- "CompetenciaFinal/TS9320_v7"

PARAM$exp_input  <- "CompetenciaFinal/FE9250_v7"

PARAM$future       <- c( 202109 )

PARAM$final_train  <- c( 201904, 201905, 201906, 201907, 201908, 201909, 202012, 202101, 202102, 202103, 202104, 202105 )

PARAM$train$training     <- c( 201904, 201905, 201906, 201907, 201908, 201909, 202012, 202101, 202102, 202103, 202104, 202105 )
